 ...
 * 注意：這個插件適用於1.5.0版本以上，因為新版本編輯器允許插件設置更加規律有效率，所以請確保軟件已經升級到最新版
 * ---
 *
 ...
 * 任務插件是非常實用的工具，它列出了多種線索，任務，目標對象等，這可以幫助玩家明確自己需要去做什麼，尤其是針對大型RPG遊戲尤為重要。
 ...
 * 這個插件創造了任務筆記系統，你可以設置任務筆記的出現方式，窗口位置大小等。這個插件提供了100個任務槽，可以通過拓展插件進行拓展，並且每一個都可以獨立設置。
 ...
 * 這是菜單中出現的默認類別：可用，已完成，失敗，全部，取消。你可以移動調整他們的順序。調整後默認情況下，會選擇第一個項目。
 默認：[“可用”，“已完成”，“失敗”，“全部”]
 * Available Text
 ...
 * 對於那些使用Main Menu Manager插件並希望將“任務”命令放在所需位置的用戶，請使用以下格式：
 ...
 * 對於這個插件，你可以使用各種腳本調用某些事件來檢查任務的進度。以下是您可以使用的各種腳本調用：
 *
